...
def _runtime_provider_credentials(v: dict, explicit_request_overrides) -> dict:
    ...
    try:
        ...
        raise ValueError(
            ...
            f"Check provider authentication with 'hermes auth list {configured_provider}' "
            "and refresh the model catalog with 'hermes model --refresh', or configure "
            "a direct delegation endpoint."
        ) from exc
