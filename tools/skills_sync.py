...
def sync_skills(quiet: bool = False) -> dict:
    ...
    if not bundled_dir.exists():
        return {"copied": [], "updated": [], "skipped": 0, "user_modified": [], "cleaned": [],
                "auto_disabled": [], "suppressed": [], "total_bundled": 0, "optional_provenance_backfilled": []}
    ...
    auto_disabled = disable_new_bundled_skills_if_configured(st.copied)
    return {
        "copied": st.copied, "updated": st.updated, "skipped": st.skipped, "user_modified": st.user_modified,
        "cleaned": cleaned, "auto_disabled": auto_disabled, "suppressed": st.suppressed, "relocated": st.relocated,
