...
def _check_all_guards(command: str, env_type: str,
    ...
    return _check_all_guards_impl(command, env_type,
                                  ...
                                  cwd=cwd, read_script=read_script)
...
def _run_approval_guards(
    command: str, env_type: str, config: Dict[str, Any], *, force: bool,
    cwd: Optional[str] = None,
    ...
    if approval.get("user_approved"):
        return _ApprovalVerdict(
            note=_format_approval_note(approval, desc),
            approved_run=True,
        )
    if approval.get("smart_approved"):
        return _ApprovalVerdict(note=_format_approval_note(approval, desc))
    return _ApprovalVerdict()
