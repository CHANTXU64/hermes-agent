        ...
        *,
        ...
        with self._lock:
            ...
            if entry is None and identity_supplied:
                ...
                #
                # Keep this recovery bounded. OAuth wrappers can supply a key
                # that matches no entry; a full lap without a real match is
                # enough evidence to surface the error instead of looping.
