    ...
    def build_kwargs(
        ...
        **params,
        ...
        params:
            ...
            session_id: str | None — physical transcript/session identity;
                remains independent from logical cache routing
            ...
            cache_scope_id: str | None — rotation-stable logical scope id
                ...
                Used as the content-addressed fallback scope only when no
                explicit prompt_cache_key is supplied
