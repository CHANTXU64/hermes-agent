...
_NON_USER_RUNTIME_CONTEXT_PREFIX = '<hermes-runtime-context user-authored="false" '
...
def is_non_user_runtime_context_message(message: Any) -> bool:
    ...
    request sanitation. The body envelope therefore remains the common identity
    across live history, SessionDB reloads, and per-request copies.
    """
