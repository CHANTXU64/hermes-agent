...
def _db_flush_row(agent, msg: Dict, is_current_turn_user: bool) -> Dict[str, Any]:
    ...
    row = {
        ...
        **{k: msg.get(k) for k in _ROW_REASONING_KEYS},
        ...
        # The nullable column remains for schema compatibility, but live/request-only
        # context is never written into durable history.
        "timestamp": timestamp, "api_content": None,
