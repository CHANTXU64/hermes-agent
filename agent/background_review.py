...
# per-agent overrides work; the text lives here. Fork memory governance owns the memory-review copy.
...
def spawn_background_review_thread(
    ...
    def _target() -> None:  # resolves _run_review_in_thread at call time (tests patch it)
        ...
        _run_review_in_thread(agent, messages_snapshot, run_prompt, task_cfg=task_cfg, review_run=review_run)
...
__all__ = [
    ...
    "spawn_background_review_thread", "build_memory_governance_context", "summarize_background_review_actions", "build_memory_write_metadata",
]
