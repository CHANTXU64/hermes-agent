...
class _Recovery(OverflowVerdict):
    ...
    api_kwargs: Any
    request_fork: Any
    request_fork_rematerializer: Any
    system_message: Any
...
def recover_from_overflow(
    ...
    messages: List[Dict[str, Any]], api_messages: Any, api_kwargs: Any, system_message: Any,
    ...
    effective_task_id: Any, current_turn_user_idx: int,
    request_fork: Any, request_fork_rematerializer: Any,
) -> OverflowVerdict:
    ...
    st = _Recovery(
        agent=agent, api_messages=api_messages, api_kwargs=api_kwargs,
        request_fork=request_fork,
        request_fork_rematerializer=request_fork_rematerializer,
        system_message=system_message, effective_task_id=effective_task_id,
        current_turn_user_idx=current_turn_user_idx, api_call_count=api_call_count,
