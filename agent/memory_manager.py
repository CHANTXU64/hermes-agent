...
_INTERNAL_NOTE_RE = re.compile(
    ...
    r'|'
    r"This is the agent's persistent memory from prior sessions,\s*for reference only\."
    r')\]\s*',
    re.IGNORECASE,
)
...
class MemoryManager:
    ...
    def _prefetch_provider(
        ...
        *,
        ...
        prefetch_timeout = self._provider_prefetch_timeout(provider)
