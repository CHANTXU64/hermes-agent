...
def compress_context(
    ...
    *,
    ...
    try:
        ...
        evidence_messages = _direct_messages_for_pre_compress_memory(
            compression_input
        )
        if checkpoint_required:
    ...
    try:
        ...
        # It therefore runs after supersession rejection but before
        # begin_commit; the commit fence remains a short, DB-only critical
        # section.
