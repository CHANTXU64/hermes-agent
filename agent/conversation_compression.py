...
from fork_features.request_fork.compression_lifecycle import (
    CompressionLifecycle,
    finalize_pending_finish,
    has_pending_finish,
)
...
def finalize_context_engine_compression_notification(agent: Any, *, committed: bool) -> bool:
    ...
    lifecycle_emitted = finalize_pending_finish(agent, committed=committed)
...
def compress_context(
    ...
    fork_lifecycle = CompressionLifecycle(
        agent,
