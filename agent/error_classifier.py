...
# runs later and treats them as retryable transport timeouts regardless of
# session size. A connection that was never established is likewise plain
# retryable transport, not context-overflow evidence.
