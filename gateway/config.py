...
def _apply_env_overrides(config: GatewayConfig) -> None:
    ...
    # Fork seam: same-profile named Telegram token discovery is owned by the
    # isolated feature module; generic Gateway config only supplies the active
    # secret scope and stores the returned account map.
    try:
