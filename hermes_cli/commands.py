...
_SLACK_VIA_HERMES_ONLY = frozenset({"credits", "blueprint"})
...
def slack_native_slashes() -> list[tuple[str, str, str]]:
    ...
    # description and hint. Keep this list tight so the fork-only /retain command
    # does not push Telegram-visible canonical commands out of Slack registration.
    _alias_to_cmd = {
        alias: cmd
        for cmd in COMMAND_REGISTRY
