...
#   - whoami/platform/insights/review: kept behind /hermes alongside the
#     Fork-only low-frequency surfaces so Slack remains below its 50-command cap.
_SLACK_VIA_HERMES_ONLY = frozenset({
    "topup", "moa", "debug", "egress", "init", "version", "diff", "update",
    "heartbeat", "refine", "review", "pause", "whoami", "platform", "insights",
    "blueprint", "disk-cleanup", "disk_cleanup", "lcm",
})
