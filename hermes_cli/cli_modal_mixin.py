...
class CLIModalMixin:
    ...
    def _clarify_callback(
        self, question, choices, multi_select=False, questions=None,
        ...
        if choices and recommended_index == 0:
    ...
    def _clarify_callback_batch(self, questions):
        ...
        for entry in questions:
            ...
            display_choices = list(display_entry.get("choices") or [])
            if display_choices and display_entry.get("recommended_index") == 0:
                display_entry["choices"] = mark_recommended(display_choices)
            display_questions.append(display_entry)
        state = {
