...
import tools.clarify_tool as clarify_module
...
class TestClarifySchema:
    ...
    def test_schema_uses_fork_owned_decision_card_policy(self):
        assert (
            clarify_module.apply_decision_card_policy
            is clarify_decision_card.apply_decision_card_policy
        )
    ...
    def test_schema_requires_a_self_contained_standalone_prompt(self):
        ...
        item_properties = CLARIFY_SCHEMA["parameters"]["properties"]["questions"][
            "items"
        ]["properties"]
        question_text = item_properties["question"]["description"].lower()
    ...
    def test_schema_rejects_invisible_context_and_post_choice_scope_growth(self):
        ...
        choices_text = item_properties["choices"]["description"].lower()
