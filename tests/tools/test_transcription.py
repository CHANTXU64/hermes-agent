...
class TestGetProvider:
    ...
    def test_custom_api_when_configured(self):
        from tools.transcription_tools import _get_provider
        stt_config = {
            "provider": "custom_api",
            "custom_api": {
    ...
    def test_custom_api_requires_key_and_base_url(self):
        from tools.transcription_tools import _get_provider
...
class TestTranscribeCustomAPI:

    def test_successful_text_response(self, tmp_path):
    ...
    def test_successful_choices_response(self, tmp_path):
        from tools.transcription_tools import _transcribe_custom_api
    ...
    def test_successful_chat_completions_response(self, tmp_path):
        from tools.transcription_tools import _transcribe_custom_api
...
class TestTranscribeAudio:
    ...
    def test_dispatches_to_custom_api(self, tmp_path):
        audio_file = tmp_path / "test.ogg"
        audio_file.write_bytes(b"fake audio")
        stt_config = {
            "provider": "custom_api",
