...
class TestSyncSkills:
    ...
    def test_fresh_install_can_auto_disable_new_bundled_skills(self, tmp_path):
        bundled = self._setup_bundled(tmp_path)
        skills_dir = tmp_path / "user_skills"
        manifest_file = skills_dir / ".bundled_manifest"
    ...
    def test_auto_disable_only_applies_to_newly_copied_skills(self, tmp_path):
        bundled = self._setup_bundled(tmp_path)
        skills_dir = tmp_path / "user_skills"
        manifest_file = skills_dir / ".bundled_manifest"
    ...
    def test_nonexistent_bundled_dir(self, tmp_path):
        ...
        assert result == {
            ...
            "user_modified": [], "cleaned": [], "auto_disabled": [], "suppressed": [], "total_bundled": 0,
