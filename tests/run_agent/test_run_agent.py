...
class TestExecuteToolCalls:
    ...
    def test_auto_memory_recall_uses_codex_tail_developer_not_instructions_or_user_suffix(self, agent):
    ...
    def test_auto_memory_recall_falls_back_to_user_suffix_for_chat_completions(self, agent):
        class _MemoryManager:
            def on_turn_start(self, *args, **kwargs):
                pass
    ...
    def test_auto_memory_recall_fallback_appends_text_part_to_current_multimodal_user(self, agent):
        class _MemoryManager:
            def on_turn_start(self, *args, **kwargs):
                pass
    ...
    def test_auto_memory_recall_codex_app_server_uses_ephemeral_user_suffix(self, agent):
        class _MemoryManager:
            def on_turn_start(self, *args, **kwargs):
                pass
