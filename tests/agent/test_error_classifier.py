...
class TestConnectionMessagePatterns:
    ...
    def test_midstream_disconnect_stays_transport_failure_on_large_session(self):
        # Fork invariant: a status-less disconnect proves a transport failure,
        # not context overflow. Session size alone must not trigger compression.
        result = classify_api_error(
