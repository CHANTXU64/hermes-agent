...
class TestConnectionMessagePatterns:
    ...
    def test_midstream_disconnect_patterns_still_use_disconnect_path(self):
        # Fork contract: a midstream disconnect is transport evidence, not
        # provider context-overflow evidence. Session pressure alone must not
        # authorize destructive compression.
        result = classify_api_error(
