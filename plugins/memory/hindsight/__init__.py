...
class HindsightMemoryProvider(MemoryProvider):
    ...
    def __init__(self):
        ...
        # Number of turns already shipped when the API supports append mode.
    ...
    def on_session_switch(
        ...
        **kwargs,
        ...
        """Flush automatic-retain state, rotate session ids, and clear stale recall."""
        ...
        if self._session_turns:
            ...
            def _flush():
                try:
                    ...
                    logger.warning("Hindsight flush-on-switch failed: %s", exc, exc_info=True)
